...
<body>
        ...
        <ul>
          ...
          <li class="nav-item">
            <a href="addToCart.html" class="nav-link add-to-cart-button" id="cartValue">
              <i class="fa-solid fa-cart-shopping" style="color: #f0f2f4;"> 0 </i>
            </a>
          </li>
        </ul>
    </nav>
    ...
    <section class="section-hero">
      <div class="container grid grid-two--cols">
        <div class="section-hero--content">
          ...
          <p class="hero-para">
            Welcome to Nishita eComStore, your ultimate destination for
        ...
        <div class="section-hero-image" data-aos="fade-up" data-aos-delay="600">
          <figure>
            <img src="./images/herosection.png" alt="coding languages using html css js" />
          </figure>
        </div>
      </div>
  ...
  <section class="Product-section">
    <div class="container-1 grid grid-three--cols">
      ...
      <div class="Div-Extra grid grid-two--cols">
        ...
        <div class="extra-img extra-headphone">
          <img src="./public/images/headphoneEcom.png" alt="">
        </div>
      </div>
      <div class="Div-Extra grid grid-two--cols">
        <div class="Extra-txt">
        ...
        <div class="extra-img extra-mobile">
          <img src="./public/images/moblies.png" alt="">
        </div>
      </div>
    </div>
  </section>
  ...
  <section class="Policy-section">
    <div class="container-2 grid grid-four--cols">
      <div class="Div-policy">
        <div class="icons">
          <i class="fa-solid fa-truck-fast"></i>
        </div>
        <div class="div-policy-txt">
  ...
  <section class="section-why--choose">
    <div class="container-3">
      <h2 class="section-common--heading">Why Choose Nishita-Store</h2>
      <p class="section-common--subheading">
        Choose Nishita EduHub for a holistic, enriching learning experience that
        empowers you to achieve your goals.
      </p>
    </div>

    <div class="container-4 grid grid-three--cols">
      <div class="choose-left-div text-align--right">
        <div class="why-choose--div" data-aos="zoom-in-up" data-aos-delay="0">
          ...
          <p>
            Nishita Store offers a diverse range of gadgets, from smartphones to
        ...
        <div class="why-choose--div" data-aos="zoom-in-up" data-aos-delay="300">
          ...
          <p>
            Every gadget at Nishita Store undergoes rigorous quality checks,
        ...
        <div class="why-choose--div" data-aos="zoom-in-up" data-aos-delay="600">
          ...
          <p>
            Enjoy great value with Nishita Store's competitive prices on
      ...
      <div class="choose-center-div" data-aos="zoom-in" data-aos-delay="300">
        <figure>
          <img src="./images/ecompost.png" alt="Nishita home page" />
        </figure>
      </div>
      <div class="choose-right-div">
        ...
        <div class="why-choose--div text-align--left" data-aos="zoom-in-up" data-aos-delay="300">
          ...
          <p>
            With Nishita Store, shopping for gadgets is easy and convenient. Our
        ...
        <div class="why-choose--div text-align--left" data-aos="zoom-in-up" data-aos-delay="600">
          ...
          <p>
            Nishita Store is committed to providing excellent service to our
